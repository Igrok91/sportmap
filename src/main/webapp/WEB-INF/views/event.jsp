                    ...
                    <div class="panel " id="eventPanel">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
                                        <c:choose>
                                            <c:when test="${event.userIdCreator == userId}">
                                                ...
                                                <li><a href="#" onclick="handleAnswer()" id="cancelAnswer"> <span class="glyphicon glyphicon-minus"
                                                                                                                  style="margin-right: 20px"></span>Отменить голос</a>
                                                </li>
                                                <li><a href="#" onclick="handleAnswer()" id="doAnswer"> <span class="glyphicon glyphicon-plus"
                                           ...
                                           <%--     <li><a href="#"> <span class="glyphicon glyphicon-share-alt"
                                                ...
                                                <li><a href="deleteGame?eventId=${event.idEvent}"><span class="glyphicon glyphicon-trash"
                                                                      style="margin-right: 20px"></span>Отменить
                                                    опрос</a></li>
                                            ...
                                            <c:otherwise>
                                                <c:set var="playgroundId" value="${event.playgroundId}" />
                                                <c:set var="sport" value="${event.sport}" />
                                                <li><a href="#" onclick="handleAnswer()" id="cancelAnswer2"> <span class="glyphicon glyphicon-minus"
                                                                                                                  style="margin-right: 20px"></span>Отменить голос</a>
                                                </li>
                                                <li><a href="#" onclick="handleAnswer()" id="doAnswer2"> <span class="glyphicon glyphicon-plus"
                                                                                                              style="margin-right: 20px"></span>Проголосовать</a>
                                                </li>
                     ...
                     <%--   <c:if test="${event.commentsList.size() != 0}">--%>
                        ...
                        <div style="margin-bottom: 15px; margin-top: 15px;">
                                <hr id="hrComment" class="hide" style="margin-top: 0px; padding-top: 0px; margin-bottom: 7px;padding-bottom: 7px">
