                                ...
                                <div class="panel-heading" style="padding-bottom: 3px; padding-top: 6px">
                                    ...
                                    <div>
                                        <a class="pull-left" href="playground?playgroundId=${event.playgroundId}&sport=${event.sport}&userId=${userId}" >
                                            ...
                                            <img id="${event.idEvent}_imgPlayground" src="resources/image/playbasket.png"
                                            ...
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu5" >
                                                <c:choose>
                                                    <c:when test="${event.userIdCreator == userId}">
                                                        ...
                                                        <li class="liOptions"><a  onclick="handleAnswerMain(${event.maxCountAnswer}, ${event.idEvent}, ${userId}, 'playerId=${userId}'), ${event.userList.size()}, '${user.photo_50}'" id="cancelAnswer_${event.idEvent}"> <span class="glyphicon glyphicon-minus"
                                                                                                                                                                                        style="margin-right: 20px"></span>Отменить голос</a>
                                                        </li>
                                                        <li class="liOptions"><a  onclick="handleAnswerMain(${event.maxCountAnswer}, ${event.idEvent}, ${userId}, 'playerId=${userId}', ${event.userList.size()}, '${user.photo_50}')" id="doAnswer_${event.idEvent}"> <span class="glyphicon glyphicon-plus"
                                                        ...
                                                        <li class="liOptions"><a href="create?playgroundId=${playgroundId}&sport=${sport}&eventId=${event.idEvent}&userId=${userId}">
                                                    <span class="glyphicon glyphicon-pencil"
                                                          style="margin-right: 20px"></span>Редактировать
                                                        </a></li>
                                                        <li class="liOptions"><a href="endGame?playgroundId=${playgroundId}&eventId=${event.idEvent}&userId=${userId}"><span class="glyphicon glyphicon-off"
                                                    ...
                                                    <c:otherwise>
                                                        <c:set var="playgroundId" value="${event.playgroundId}" />
                                                        <c:set var="sport" value="${event.sport}" />
                                                        <li class="liOptions"><a  onclick="handleAnswerMain(${event.maxCountAnswer}, ${event.idEvent}, ${userId}, 'playerId=${userId}', ${event.userList.size()}, '${user.photo_50}')" id="cancelAnswer2_${event.idEvent}"> <span class="glyphicon glyphicon-minus"
                                                                                                                                                                                         style="margin-right: 20px"></span>Отменить голос</a>
                                                        </li>
                                                        <li class="liOptions"><a  onclick="handleAnswerMain(${event.maxCountAnswer}, ${event.idEvent}, ${userId}, 'playerId=${userId}', ${event.userList.size()}, '${user.photo_50}')" id="doAnswer2_${event.idEvent}"> <span class="glyphicon glyphicon-plus"
                                                                                                                                                                                     style="margin-right: 20px"></span>Проголосовать</a>
                                                        </li >
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <a href="user?playerId=${user.userId}&userId=${userId}" class="btn"  style="padding: 0px" id="${user.userId}_imgUser_${event.idEvent}">
                                                                <img src="${user.photo_50}" alt="Баскетбол" width="35" class="round media-object "
