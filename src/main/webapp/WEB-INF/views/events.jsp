...
<body>
<a href="#" class="btn hide" style="color: gray" id="all2"> <span class="glyphicon glyphicon-eye-open"
...
<div class="panel  hide" id="eventsGame">
        ...
        <div>
            ...
            <div class="pull-right dropdown" style=" margin-top: 4px;margin-bottom: 4px; ">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
                    ...
                    <li><a href="#"> <span class="glyphicon glyphicon-time" style="margin-right: 20px"></span>История
                        изменений</a></li>
                    <li><a href="#"> <span class="glyphicon glyphicon-home" style="margin-right: 20px"></span>К площадке</a>
                    </li>
                    <li><a href="#"> <span class="glyphicon glyphicon-share-alt" style="margin-right: 20px"></span>К
                        записи</a></li>
                    <li><a href="#"> <span class="glyphicon glyphicon-minus" style="margin-right: 20px"></span>Отменить
                        голос</a></li>
                    <li><a href="#">
                    ...
                    <li><a href="#"><span class="glyphicon glyphicon-trash" style="margin-right: 20px"></span>Отменить
                        опрос</a></li>
    ...
    <div>
        <a href="#" class="btn" style="margin-left: 5px" id="creatorEvent"><span class="glyphicon glyphicon-user "
                                                                                 aria-hidden=""
                                                                                 style="margin-right: 5px"></span> <span
                id="NameCreator">Леонид Заручевский</span></a>
    </div>
    ...
    <a href="#" class="btn" style=" margin-left: 5px;margin-top: 4px; margin-bottom: 4px" id="comment"><span
            class="glyphicon glyphicon-comment " aria-hidden="Комментировать"
            style="color: #77A5C5;margin-right: 5px"></span>4</a>
