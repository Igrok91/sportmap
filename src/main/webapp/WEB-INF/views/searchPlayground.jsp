        ...
        <div class="pull-right dropdown" style="padding-top: 10px">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu5">
                <li><a href="#" class="list-group-item borderless">
                    <div class="media">
                        ...
                        <div class="media-body ">
                            <h4 class="media-heading" style="padding-bottom: 0px; margin-bottom: 0px; margin-top: 0px">
                                Футбол</h4>
                        </div>
                    </div>
                </a></li>
                <li><a href="#" class="list-group-item borderless">
                    <div class="media">
                        <div class="pull-left">
                            <img class="media-object" src="resources/image/basket.png" alt="Футбол" width="20"
                                 height="20"/>
                        </div>
                ...
                <li><a href="#" class="list-group-item borderless">
                    <div class="media">
                        <div class="pull-left">
                            <img class="media-object" src="resources/image/voley.png" alt="Футбол" width="20"
                                 height="20"/>
                        </div>
